...
data_directory = os.path.expanduser("~/mother_infant/data_latest/")
metadata_directory = os.path.expanduser("~/mother_infant/scripts/metadata/")
analysis_directory = os.path.expanduser("~/mother_infant/analysis_latest/")
scripts_directory = os.path.expanduser("~/mother_infant/scripts/")
...
fixation_min_change = 0.6 # Originally consensus_upper_threshold - consensus_lower_threshold
