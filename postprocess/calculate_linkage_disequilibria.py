from utils import sample_utils, config, parse_midas_data, diversity_utils, substitution_rates_utils, clade_utils
...
ld_directory = '%s/linkage_disequilibria/' % (config.data_directory)
...
for species_name in good_species_list:
		...
		dummy_samples, snp_difference_matrix, snp_opportunity_matrix = substitution_rates_utils.calculate_matrices_from_substitution_rate_map(substitution_rate_map, 'core', allowed_samples=snp_samples)
		...
		for clade_type in clade_types:
				for variant_type in variant_types:
						...
						# Calculate pi!
						dummy_samples, snp_difference_matrix, snp_opportunity_matrix = substitution_rates_utils.calculate_matrices_from_substitution_rate_map(substitution_rate_map, variant_type, allowed_samples=desired_samples)
