...
# ===================================================================================
# Verifies that MIDAS post-merge output is complete
# 
...
snps_files='readme.txt  snps_alt_allele.txt.bz2  snps_depth.txt.bz2  snps_info.txt.bz2  snps_log.txt  snps_ref_freq.txt.bz2  snps_summary.txt'
